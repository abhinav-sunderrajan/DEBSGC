...
public class DisplayBoltQuery2 implements IRichBolt {
	...
	private static final Logger LOGGER = Logger.getLogger(DisplayBoltQuery2.class);
	...
	public void prepare(Map stormConf, TopologyContext context, OutputCollector collector) {
		...
		// "% Plugs above global median", (String)
		// stormConf.get("image.save.directory"),
		...
		// barchart.getDataset().addValue(entry.getValue(), entry.getKey(),
		// String.valueOf(i));
		// }
		//
		// }
		...
		// TimeSeries("Throughput/sec for Subscriber# " + this.hashCode(),
	...
	public void execute(Tuple input) {
		...
		// if ((Calendar.getInstance().getTimeInMillis() - timer.get()) >=
		// 30000) {
